 ...
 */ (function ($, window, undefined) {
	...
	var iView = function (el, options) {
			...
			//Set Timer Element
			iv.sliderContent.append('<div id="box_timer"><div id="iview-timer"><div></div></div></div>');
			...
			$('.iview-video', iv.slider).click(function(e){
				...
				if(!$(e.target).hasClass('iview-video-close') && !$(e.target).hasClass('iview-caption') && !$(e.target).parents().hasClass('iview-caption')){
					video.show().animate({ top: 0 }, 10, 'easeOutBounce');
	...
	iView.prototype = {
		...
		startSlider: function () {
			...
			if (iv.options.directionNav) {
				iv.sliderContent.append('<div class="iview-directionNav"><div class="nav_box"><a class="iview-prevNav" title="' + iv.options.previousLabel + '">' + iv.options.previousLabel + '</a><a class="iview-nextNav" title="' + iv.options.nextLabel + '">' + iv.options.nextLabel + '</a><span></span></div></div>');
